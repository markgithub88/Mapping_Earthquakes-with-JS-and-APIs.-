...
let techtonicplates = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json"

  d3.json(techtonicplates).then(function(techdata) {
	L.geoJson(techdata, {
    	// We turn each feature into a circleMarker on the map.
		color: "#ff6500",
		weight: 2
